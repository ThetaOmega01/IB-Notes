...
\[
	D \teval{\sigma}{0}(\hat v) = v;\quad D \teval{\sigma}{0}(\hat w) = w;\quad \sigma(0) = p
\]
Then,
\[
	\Iff_p(v,w) = {\hat v}^\top \begin{pmatrix}
		E & F \\
		F & G
	\end{pmatrix} \hat w;\quad \IIff_p(v,w) = {\hat v}^\top \begin{pmatrix}
		L & M \\
		M & N
	\end{pmatrix} \hat w
\]
